function [Gamma_est,R_est,Gamma_est_nT,R_est_nT,x_c,cutoff,all_total,nb_pdf,div_pdf,total_nb_pdf,total_div_pdf,nb,div,total_nb,total_div] = inverseProblem_experimental_H9_lactate_func()
clear

%% Constants/Inputs
nb_i = "H9";
div_i = "H9";
iso_fName = "H9CNTRL_Lactate.csv";
mu = 0.0188;
